...
public class termsConfirmationPOST extends PropertiesReader {

	@Test
	public void TermsConfirmationPOST(String actid) throws IOException {

		ValidatableResponse putres;
		termsconfirmationdata data = new termsconfirmationdata();
		...
		putres = given().spec(requestSpecification())
				...
				.body(data.termsconfirm("version"))
				.when().log().all(true)
				.post(Global.getGlobalvalue("termsconfirmation"))
				.then().statusCode(200)
				.log().all(true);
