...
public class Headers {
		...
		public HashMap<String, ?> sessiontokenheader() {
	        HashMap<String, String> headers = new HashMap<String, String>();
	        headers.put(Constant.SESSION_TOKEN, Constant.Session_ID_Value);
	        return headers;
		}
		
		public HashMap<String, ?> appidheaders() {
	        HashMap<String, String> headers = new HashMap<String, String>();
	        headers.put(Constant.APP_ID, Constant.APP_ID_Value);
	        return headers;
		}
