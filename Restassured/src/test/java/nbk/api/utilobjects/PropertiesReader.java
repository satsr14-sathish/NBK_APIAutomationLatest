...
public class PropertiesReader {
	...
	public RequestSpecification requestSpecification1() throws IOException {
		...
		RestAssured.baseURI = "https://dvp-qa-manual:8080/";
		req = new RequestSpecBuilder().setBaseUri(getGlobalvalue("BaseURL2"))
				.setContentType(ContentType.JSON).build();
		return req;
	...
	public RequestSpecification requestSpecification2() throws IOException {
		...
		RestAssured.baseURI = "https://dvp-qa-manual:8080/";
		req = new RequestSpecBuilder().setBaseUri(getGlobalvalue("BaseURL1")).setBasePath(getGlobalvalue("BasePATH2"))
				.setContentType(ContentType.JSON).build();
		return req;
	}
