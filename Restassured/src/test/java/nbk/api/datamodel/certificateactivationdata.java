...
public class certificateactivationdata {
	...
	public certificateactivation certificateactiv(String certificateauuth) {
		...
		certificateact.setCertificateSigningRequestB64("MIG5MGUCAQAwADBcMA0GCSqGSIb3DQEBAQUAA0sAMEgCQQCW7vBpct/S3A4PAodTHTxKe0cm+uH7C5KJ8qIh+SN7+tDBOQGCzlMQmOJu7HHPscaHcADNdlaNiLqIgIlqctJLAg"
